...
root_path = os.path.dirname(os.path.dirname(directory))

import sys
#sys.path.insert(0, "/Users/cookie/workspace/aida-texas/aida-utexas")
sys.path.insert(0, root_path + "aida-utexas")
