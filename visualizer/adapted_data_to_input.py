...
if __name__ == "__main__":
    ...
    parser.add_argument("--out_data_dir", type=str, default="Mixtures", help='Folder where the mixtures will be written (will be created by the script, if it does not already exist)')
    parser.add_argument("--first_js_folder", type=str, default="js-wiki-new-ontology", help='First directory containing json graphs')
    ...
    make_mixture_data(first_js_folder, second_js_folder, out_data_dir, num_sources, num_shared_eres, data_size, size_cut, print_every, min_connectedness_one_step, min_connectedness_two_step, perc_train, perc_val, perc_test)
