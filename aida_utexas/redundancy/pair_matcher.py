...
def main():
	...
	if args.write_matching == "True":
		#get_matching(args.query_file, args.docclaim_file, args.redundancy_file, args.output_path)
	...
	if args.write_nli_input == "True":
		#get_nli_input(args.query_file, args.docclaim_file, args.redundancy_file, args.output_path)
